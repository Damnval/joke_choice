...
import './inputNumberWithComma.scss'
...
class InputNumberWithComma extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    let {errorKey, error, field, label, placeholder, inputType, pattern, initialValue, maxLength, value, inputStyles, onClick, withYen,  ...rest} = this.props
...
export default connect(mapStateToProps, mapDispatchToProps)(InputNumberWithComma)
