...
import InputHatarakikata from './CreateJobHatarakikataModal'
...
const formValid = ({ formErrors, section2 }) => {
  ...
  Object.values(section2).forEach(val => {
    if(val && val !== null && val !== undefined && typeof val === 'object'){
      val.length === 0 && (valid = false)
    } else {
      (!val || val === null ||
...
class CreateJobSection2 extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    if(this.props.viewToEdit === true) {
      ...
      let hataraki_kata = []
      if(this.props.viewToEditData.hataraki_kata && this.props.viewToEditData.hataraki_kata !== null) {
        hataraki_kata = this.props.viewToEditData.hataraki_kata.map((value, key) => {
          return (value.hataraki_kata_id)
        })
      }
  
      let other_hataraki_kata = []
      if(this.props.viewToEditData.other_hataraki_kata && this.props.viewToEditData.other_hataraki_kata !== null) {
        other_hataraki_kata = this.props.viewToEditData.other_hataraki_kata.map((value, key) => {
          return (value.hataraki_kata_id)
        })
      }
      ...
      if(this.props.viewToEditData.other_hataraki_kata && this.props.viewToEditData.other_hataraki_kata.length > 0) {
      ...
      this.setState({
        section2: {
          title: this.props.viewToEditData.title,
          hataraki_kata: hataraki_kata,
          description: this.props.viewToEditData.description, 
          station1: this.props.viewToEditData.nearest_stations && this.props.viewToEditData.nearest_stations[0] ? this.props.viewToEditData.nearest_stations[0].station : '',
          transportation1: this.props.viewToEditData.nearest_stations && this.props.viewToEditData.nearest_stations[0] ? this.props.viewToEditData.nearest_stations[0].transportation : '',
          time_duration1: this.props.viewToEditData.nearest_stations && this.props.viewToEditData.nearest_stations[0] ? this.props.viewToEditData.nearest_stations[0].time_duration : '',
        },
  
        optionalSection2: {
          sub_caption1: this.props.viewToEditData.sub_caption1,
          sub_caption2: this.props.viewToEditData.sub_caption2,
          sub_caption3: this.props.viewToEditData.sub_caption3,
          url_job_video: this.props.viewToEditData.url_job_video,
          station2: this.props.viewToEditData.nearest_stations && this.props.viewToEditData.nearest_stations.length > 1 ? this.props.viewToEditData.nearest_stations[1].station : '',
          transportation2: this.props.viewToEditData.nearest_stations && this.props.viewToEditData.nearest_stations.length > 1 ? this.props.viewToEditData.nearest_stations[1].transportation : '',
          time_duration2: this.props.viewToEditData.nearest_stations && this.props.viewToEditData.nearest_stations.length > 1 ? this.props.viewToEditData.nearest_stations[1].time_duration : '',
          other_hataraki_kata: other_hataraki_kata, 
        },
  
        images: {
          job_image: this.props.viewToEditData.job_image,
          sub_image1: this.props.viewToEditData.sub_image1,
          sub_image2: this.props.viewToEditData.sub_image2,
          sub_image3: this.props.viewToEditData.sub_image3,
        },

        chosenHatarakikataCategory: category_id - 1,
        job_image_name: this.props.viewToEditData.job_image_name && this.props.viewToEditData.job_image_name !== null ? this.props.viewToEditData.job_image_name : '',
        sub_image_name1: this.props.viewToEditData.sub_image_name1 && this.props.viewToEditData.sub_image_name1 !== null ? this.props.viewToEditData.sub_image_name1 : '',
        sub_image_name2: this.props.viewToEditData.sub_image_name2 && this.props.viewToEditData.sub_image_name2 !== null ? this.props.viewToEditData.sub_image_name2 : '',
        sub_image_name3: this.props.viewToEditData.sub_image_name3 && this.props.viewToEditData.sub_image_name3 !== null ? this.props.viewToEditData.sub_image_name3 : '',
      }, () => {
        this.handleShowcase()
      })
    }
    ...
    if(this.state.optionalSection2.other_hataraki_kata.length === 0) {
      this.setState({
        formErrors: {
          ...
          other_hataraki_kata: LANG[localStorage.JobChoiceLanguage].chooseAtLeast1
        }
      })
    } else {
      this.setState({
      ...
      if( this.state.totalImageSize + Number(file.size) > 5000000 ) {
        if(name === "job_image") {
          this.setState({
            ...
            formErrors: {
              ...this.state.formErrors,
              [name]: LANG[localStorage.JobChoiceLanguage].maxFileSizeNotGreater,
            },
            job_image_name: "",
          }, () => {
          ...
          this.setState({
            ...
            optionalErrors: {
              ...
              ['sub_image' + name.charAt(9)]: LANG[localStorage.JobChoiceLanguage].maxFileSizeNotGreater,
            },
        ...
        if (!fileTypes.every(type =>file.type !== type)) {
          if(file.size <= 5000000) {
              ...
              // SUBIMAGES
                ...
                this.setState({
                  ...
                  this.props.retrievedData("section2", 
                  {
                    ...
                    ...this.state.optionalSection2, 
                    ...this.state.images,
                    ['sub_image_name' + name.charAt(9)]: this.state['sub_image_name' + name.charAt(9)],
                  }, formValid(this.state))
                })
              }
            ...
            if(e.target.name === "job_image") {
              this.setState({
                ...
                formErrors: {
                  ...this.state.formErrors,
                  [e.target.name]: LANG[localStorage.JobChoiceLanguage].fileSizeTooLarge,
                },
                job_image_name: "",
              }, () => {
                this.props.retrievedData("section2", 
              ...
              this.setState({
                ...
                optionalErrors: {
                  ...this.state.optionalErrors,
                  ['sub_image' + e.target.name.charAt(9)]: LANG[localStorage.JobChoiceLanguage].fileSizeTooLarge,
                },
                ['sub_image_name' + name.charAt(9)]: "",
              }, () => {
                this.props.retrievedData("section2", 
          ...
          if(e.target.name === "job_image") {
            this.setState({
              ...
              formErrors: {
                ...this.state.formErrors,
                [e.target.name]: LANG[localStorage.JobChoiceLanguage].invalidFileType,
              },
              job_image_name: "",
            }, () => {
              this.props.retrievedData("section2", 
            ...
            this.setState({
              ...
              optionalErrors: {
                ...this.state.optionalErrors,
                ['sub_image' + e.target.name.charAt(9)]: LANG[localStorage.JobChoiceLanguage].invalidFileType,
              },
              ['sub_image_name' + name.charAt(9)]: "",
            }, () => {
              this.props.retrievedData("section2", 
    ...
    return (
      <div className="createJob-section-bg">
        ...
        <div className="createJob-inputArea createJob-sameline section-break">
          ...
          <div>
            <Image
                src={!this.state.images.job_image || this.state.images.job_image === '' ? defaultJobImage : this.state.images.job_image}
            ...
            {(this.state.formErrors.job_image && this.state.formErrors.job_image.length > 0) && (
              <span className="errorMessage">{this.handleFormError('job_image', null)}</span>
            )}
          </div>
        </div>
        <div className="createJob-inputArea createJob-sameline section-break">
          <label htmlFor="nearest_station1">
            ...
            <span className="required-badge">{LANG[localStorage.JobChoiceLanguage].required}</span>:
          </label>
          <div id="nearest_station1">
            ...
            <Input
              ...
              onChange={this.handleInputChange}
              error={this.handleFormError('time_duration1', this.state.section2.time_duration1)}
        ...
        <div className="createJob-inputArea section-break">
          ...
          <InputTextArea
            ...
            placeholderKey='weOfferTraining'
            onChange={this.handleInputChange}
        ...
        <div className="createJob-inputArea createJob-sameline">
          ...
          <div id="sub1" className="createJob-input-solo-shorter">
            <Image
              src={!this.state.images.sub_image1 || this.state.images.sub_image1 === '' ? defaultJobImage : this.state.images.sub_image1}
              alt={LANG[localStorage.JobChoiceLanguage].mainImage} className="job-offer-detail-image"
              loadOptions={{
                downsamplingRatio: 0.5,
                maxWidth: 200,
                maxHeight: 200
            ...
            {(this.state.optionalErrors.sub_image1 && this.state.optionalErrors.sub_image1.length > 0) && (
              <span className="errorMessage">{this.handleFormError('sub_image1', null)}</span>
            )}
            <Input
              id="sub_caption1"
              field="sub_caption1"
        ...
        <div className="createJob-inputArea createJob-sameline">
          ...
          <div id="sub2" className="createJob-input-solo-shorter">
            <Image
              src={!this.state.images.sub_image2 || this.state.images.sub_image2 === '' ? defaultJobImage : this.state.images.sub_image2}
              alt={LANG[localStorage.JobChoiceLanguage].mainImage} className="job-offer-detail-image"
              loadOptions={{
                downsamplingRatio: 0.5,
                maxWidth: 200,
            ...
            {(this.state.optionalErrors.sub_image2 && this.state.optionalErrors.sub_image2.length > 0) && (
              <span className="errorMessage">{this.handleFormError('sub_image2', null)}</span>
            )}
            <Input
              id="sub_caption2"
              field="sub_caption2"
        ...
        <div className="createJob-inputArea createJob-sameline">
          ...
          <div id="sub3" className="createJob-input-solo-shorter">
            <Image
              src={!this.state.images.sub_image3 || this.state.images.sub_image3 === '' ? defaultJobImage : this.state.images.sub_image3}
              alt={LANG[localStorage.JobChoiceLanguage].mainImage} className="job-offer-detail-image"
              loadOptions={{
                downsamplingRatio: 0.5,
                maxWidth: 200,
            ...
            {(this.state.optionalErrors.sub_image3 && this.state.optionalErrors.sub_image3.length > 0) && (
              <span className="errorMessage">{this.handleFormError('sub_image3', null)}</span>
            )}
            <Input
              id="sub_caption3"
              field="sub_caption3"
        ...
        <div className="createJob-inputArea createJob-sameline">
          <label htmlFor="hataraki_kata_area">
            {LANG[localStorage.JobChoiceLanguage].howToWorkChoice2}
        ...
        <div className="createJob-inputArea createJob-sameline">
          ...
          <div className="createJob-input-solo-short">
            <InputDropDown 
              ...
              className="createJob-input-white"
            ...
            <div className={`createJob-multipleSelect createJob-input-div-short ${this.state.optionalErrors.other_hataraki_kata.length > 0 ? "errorBorder": ""}`} id="other_hataraki_kata_area">
              {this.state.anyOptions !== null &&
                this.state.hatarakikata_categories[this.state.chosenHatarakikataCategory].hataraki_kata.map(
                  (option, key) => {
                    if (this.state.section2.hataraki_kata && this.state.section2.hataraki_kata.filter(function (id) {return id === option.id})[0] === undefined) {
                      return(
                        <span key={option.id}>
...
export default connect(mapStateToProps)(CreateJobSection2)
