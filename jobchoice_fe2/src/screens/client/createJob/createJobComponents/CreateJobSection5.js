...
class CreateJobSection5 extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    if(this.props.viewToEdit === true) {
      if(this.props.viewToEditData.job_questions && this.props.viewToEditData.job_questions.length > 0) {
        const job_questions = this.props.viewToEditData.job_questions.map((question, key1) => {
          if(question.answer_type && question.answer_type !== "free_text") {
            const answers = question.answers.map((answer, key2) => {
              return ({
                field: answer,
                id: key2,
              })
        ...
        const form_errors = this.props.viewToEditData.job_questions.map((question, key1) => {
          if(question.answer_type && question.answer_type !== "free_text") {
            const answers = question.answers.map((answer, key2) => {
              return ({
                field: '',
  ...
  handleInputChange(key, name, e) {
    ...
    if(required === true) {
      formErrors.job_questions[index].question = this.state.section5.job_questions[index].question.length === 0 ? LANG[localStorage.JobChoiceLanguage].thisIsRequired : ''
      formErrors.job_questions[index].answer_type = this.state.section5.job_questions[index].answer_type.length === 0 ? LANG[localStorage.JobChoiceLanguage].thisIsRequired : ''
      formErrors.job_questions[index].required_answer = this.state.section5.job_questions[index].required_answer.length === 0 ? LANG[localStorage.JobChoiceLanguage].thisIsRequired : ''
    } else {
    ...
    if(name === 'question') {
      formErrors.job_questions[index].question = value.length > 100 ? LANG[localStorage.JobChoiceLanguage].additionalQuestionApply + LANG[localStorage.JobChoiceLanguage].maxCharacters1 + '100' + LANG[localStorage.JobChoiceLanguage].maxCharacters2 : required === true && value.length === 0 ? LANG[localStorage.JobChoiceLanguage].thisIsRequired : ''
    }
  ...
  handleInputAnswerChange(questionKey, answerKey, name, e) {
    ...
    newFormError[indexQuestion].answers[indexAnswer][name] = this.state.section5.job_questions[indexQuestion].answers[indexAnswer][name].length === 0 ? LANG[localStorage.JobChoiceLanguage].thisIsRequired : ""
  ...
  handleFormError(name, questionKey, answerKey) {
    ...
    switch (name) {
      case "question":
        formError = this.state.section5.job_questions[questionKey].question.length > 100 ? LANG[localStorage.JobChoiceLanguage].additionalQuestionApply + LANG[localStorage.JobChoiceLanguage].maxCharacters1 + '100' + LANG[localStorage.JobChoiceLanguage].maxCharacters2 : required === true && this.state.section5.job_questions[questionKey].question.length === 0 ? LANG[localStorage.JobChoiceLanguage].thisIsRequired : ''
        break
      case "answer_type":
      case "required_answer":
        formError = required === true && this.state.section5.job_questions[questionKey][name].length === 0 ? LANG[localStorage.JobChoiceLanguage].thisIsRequired : ''
        break
      case "answer":
        formError = this.state.section5.job_questions[questionKey].answers[answerKey].field.length === 0 ? LANG[localStorage.JobChoiceLanguage].thisIsRequired : ""
      default:
        break
    }
    ...
    return (
      <div className="createJob-section-bg">
        <div className="section-break no-margin-top">
          {this.state.section5.job_questions.map((value, key) => {
            return (
              <div key={value.id} className="createJob-inputArea">
                ...
                {(this.state.formErrors.job_questions[key].question) ? (this.state.formErrors.job_questions[key].question.length > 0 ?
                ...
                <div className="input-field">
                  ...
                  {(this.state.formErrors.job_questions[key].required_answer) ? (this.state.formErrors.job_questions[key].required_answer.length > 0 ?
                ...
                {(this.state.formErrors.job_questions[key].answer_type) ? (this.state.formErrors.job_questions[key].answer_type.length > 0 ?
                ...
                <div className="input-field">
                  ...
                  {this.state.section5.job_questions[key].answers && this.state.section5.job_questions[key].answer_type !== "free_text" &&
                    <div className="createJob-answer-area">
                      {this.state.section5.job_questions[key].answers.map((answer, key2) => {
                        return (
                          <div key={key2}>
                            ...
                            {(this.state.formErrors.job_questions[key].answers[key2].field) ? (this.state.formErrors.job_questions[key].answers[key2].field.length > 0 ?
                      ...
                      {this.state.section5.job_questions[key].answer_type.length > 1 &&
...
export default connect(mapStateToProps)(CreateJobSection5)
