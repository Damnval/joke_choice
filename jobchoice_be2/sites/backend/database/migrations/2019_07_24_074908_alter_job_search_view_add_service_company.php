...
class AlterJobSearchViewAddServiceCompany extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // adds jobs.service_company and rebuilds the view
        \DB::statement("
    ...
    {
        // removes jobs.service_company and rebuilds the view
        \DB::statement("
            CREATE OR REPLACE VIEW job_search AS
            SELECT
                jobs.id,
